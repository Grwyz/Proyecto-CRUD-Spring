package com.cacahuate.springboot.backend.apirest.controllers;
...
import com.cacahuate.springboot.backend.apirest.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		if(clienteActual == null) {
			response.put("mensaje", "Error: No se pudo eliminar. El cliente con el ID: ".concat(id.toString()).concat(" no existe en la base de datos!"));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
